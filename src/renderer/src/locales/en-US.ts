export default {
  ...
  buttonMapping: {
    ...
    macro: {
      ...
      bindSuccess: '{name} bound to current button',
      ...
      clickToEditKey: 'Click to edit key',
      clickToToggleType: 'Click to toggle down/up',
      clickToEditDelay: 'Click to edit delay',
      deleteEvent: 'Delete this event',
      addEvent: 'Add event',
      addKeyboard: 'Keyboard Key',
